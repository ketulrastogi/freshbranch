                          ...
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  child: Text('${cartService.getTotalAmountOfCart().toDouble().toString()}'),
                                ),
                              ],
                            ),
                          ),
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  child: Text('${(cartService.getTotalAmountOfCart().toDouble() * 0.05).floor().toDouble()}'),
                                )
                              ],
                            ),
                          ),
                          ...
                          Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  child: Text(
                                    '${cartService.getTotalAmountOfCart().toDouble() - (cartService.getTotalAmountOfCart().toDouble() * 0.05).floor().toDouble()}',
                                    style: Theme.of(context).textTheme.subtitle,
                                  ),
                                )
                              ],
